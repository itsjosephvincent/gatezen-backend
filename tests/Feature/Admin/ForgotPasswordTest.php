...
{
    public function test_valid_admin_email_required()
    {
        $payload = [
            'email' => rand() . 'xyz@gmail.com',
        ];

        $this->json('POST', 'api/admin/forgot-password', $payload)
            ->assertStatus(400)
            ->assertJson([
    ...
    public function test_can_request_forgot_password()
    {
    ...
    public function test_token_is_required()
    {
        ...
        $this->json('POST', 'api/admin/verify-reset-password', $payload)
            ->assertStatus(422)
            ->assertJson([
                'message' => 'The given data was invalid.',
                'errors' => [
