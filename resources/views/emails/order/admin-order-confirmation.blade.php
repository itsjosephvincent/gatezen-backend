        ...
        <div style="width: 75%">
            <table style="margin-top: 25px;">
                ...
                <table width="100%" style="border-left: 1px solid black; border-right: 1px solid black;">
                    ...
                    <tr>
                        <td>
                            <p style="font-size: small; margin-left: 10px; font-weight: 500;">Congratulations,</p>
                            <p style="font-size: small; margin-left: 10px; font-weight: 500;">There has been a new order. See the details below:</p>
